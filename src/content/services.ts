...
export const services: readonly ServiceItem[] = [
  ...
  },
  {
    ...
    tasks: [
      'ИИ-ассистент на сайте, в Telegram или МАКС — отвечает по вашим документам и каталогу',
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Да. ИИ-ассистент работает на сайте, в Telegram или МАКС и передаёт заявки с историей диалога в Битрикс24 или 1С. Сложные обращения автоматически переводятся на оператора.',
      },
    ],
    relatedCases: [],
  },
