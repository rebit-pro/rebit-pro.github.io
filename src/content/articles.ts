...
export const articles: readonly Article[] = [
  ...
  },
  {
    ...
    metaDescription:
      'Разбираем 6 сценариев, где ИИ реально приносит бизнесу пользу: поддержка клиентов 24/7, квалификация лидов, разгрузка менеджеров, наполнение каталога и обработка документов.',
    keywords: [
      'ии для бизнеса',
      'внедрение ии',
      'разработка ии',
