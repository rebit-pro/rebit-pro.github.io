...
export const siteConfig = {
  ...
  description:
    'ReBit Studio разрабатывает сайты, интернет-магазины, приложения, чат-боты и мини-приложения (Telegram, МАКС), внедряет Битрикс24 и делает интеграции на PHP, 1С-Битрикс и Vue.',
...
export const routeMeta = {
  ...
  services: {
    title: 'Услуги ReBit Studio — сайты, приложения, боты, Битрикс24 и интеграции',
    description:
      'Разработка сайтов и магазинов, приложений, чат-ботов и мини-приложений для Telegram и МАКС, внедрение Битрикс24, доработка 1С-Битрикс и интеграции.',
  },
  prices: {
