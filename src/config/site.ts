...
export const siteConfig = {
  ...
  description:
    'ReBit Studio разрабатывает сайты, интернет-магазины, приложения, чат-боты и мини-приложения (Telegram, МАКС), внедряет Битрикс24, делает интеграции и AI-решения для бизнеса — AI-чат-боты, ассистентов и автоматизацию — на PHP, 1С-Битрикс и Vue.',
...
export const routeMeta = {
  home: {
    title: 'ReBit Studio — сайты, Bitrix, интеграции и AI для бизнеса',
    description: siteConfig.description,
  },
  services: {
    title: 'Услуги ReBit Studio — сайты, боты, Битрикс24, интеграции и AI',
    description:
      'Разработка сайтов и магазинов, приложений, чат-ботов и мини-приложений для Telegram и МАКС, AI-боты и автоматизация бизнес-процессов, внедрение Битрикс24, доработка 1С-Битрикс и интеграции.',
  },
  prices: {
