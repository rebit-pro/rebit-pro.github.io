...
export const profile = {
  name: 'ReBit Studio',
  role: 'Сайты, веб-сервисы и боты для бизнеса',
  shortRole: 'Разработка, поддержка, развитие',
  experience: 'Vibe Coding + Deep Coding',
  tagline: 'Лендинг — 20 000 ₽. Сайт 5–7 страниц — 50 000 ₽. Микро-MVP — от 100 000 ₽.',
  summary:
    'Типовые сайты запускаем быстро с AI-инструментами и ручной проверкой. ' +
    'Кабинеты, платежи, интеграции, 1С-Битрикс и сложную логику разрабатываем ' +
    'в инженерном Deep-режиме.',
...
export const heroBadges: readonly HeroBadge[] = [
  { title: 'Сайты', icon: 'mdi-web' },
  { title: 'MAX и Telegram', icon: 'mdi-robot-outline' },
  { title: 'Web и MVP', icon: 'mdi-application-braces-outline' },
...
export const heroSolves: readonly string[] = [
  'Лендинги и сайты-визитки с фиксированным составом и ценой',
  'Чат-боты и мини-приложения для MAX и Telegram',
  'Микро-MVP, кабинеты, админки и веб-сервисы',
  '1С-Битрикс, Битрикс24, интеграции с 1С, CRM и оплатами',
]
...
export const services: readonly ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      'Чат-боты и мини-приложения для MAX и Telegram: заявки, продажи, заказы ' +
...
// AI для бизнеса — примеры пользы (не хайп). Карточки на главной ведут к AI-услугам.
export const aiSolutions: readonly ServiceItem[] = [
  {
    title: 'Поддержка клиентов 24/7',
    icon: 'mdi-headset',
    description:
      'ИИ-ассистент круглосуточно отвечает на типовые вопросы по вашей базе знаний, ' +
      'а сложное передаёт оператору — без роста штата поддержки.',
  },
  {
    title: 'Меньше потерянных лидов',
    icon: 'mdi-account-arrow-right-outline',
    description:
      'Бот квалифицирует обращение, собирает контакты и сразу заводит сделку в CRM ' +
      'с историей диалога — заявки не теряются ночью и в выходные.',
  },
  {
    title: 'Менеджеры успевают больше',
    icon: 'mdi-rocket-launch-outline',
    description:
      'Авто-резюме обращений, черновики ответов и расшифровка звонков снимают ' +
      'рутину с отделов продаж и поддержки.',
  },
  {
    title: 'Каталог наполняется быстрее',
    icon: 'mdi-tag-text-outline',
    description:
      'Описания товаров, мета-теги и переводы для тысяч карточек — массово, ' +
      'в едином стиле и с проверкой редактором.',
  },
  {
    title: 'Документы без ручного ввода',
    icon: 'mdi-file-document-multiple-outline',
    description:
      'Счета, договоры и накладные распознаются и попадают в 1С или CRM — ' +
      'меньше ручной работы и ошибок оператора.',
  },
  {
    title: 'Данные под контролем',
    icon: 'mdi-shield-lock-outline',
    description:
      'Облачные API, российские YandexGPT и GigaChat или self-hosted модели ' +
      'в вашем контуре — подбираем под требования к данным.',
  },
]
...
// Снятие риска (risk reversal) для продуктовых пакетов и индивидуальной разработки.
...
export const typicalTasks: readonly TaskItem[] = [
  ...
  {
    title: 'Нужен бот или мини-приложение в MAX / Telegram',
...
export const faqItems: readonly FaqItem[] = [
  ...
  {
    question: 'Делаете ботов и мини-приложения для MAX и Telegram?',
    answer:
      'Да. Разрабатываем чат-боты и мини-приложения (магазин, каталог, личный кабинет, оплаты) ' +
      'для MAX и Telegram на Vue и PHP, со связкой с Битрикс24 или 1С.',
  },
  {
...
export const about = {
  summary:
    'ReBit Studio соединяет быстрый запуск типовых решений с инженерной практикой ' +
    'сложных PHP / Bitrix-проектов. Не раздуваем простой сайт до enterprise-сметы ' +
    'и не упрощаем рискованный продукт до бесконтрольной генерации.',
  highlights: [
