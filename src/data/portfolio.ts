...
export const profile = {
  ...
  role: 'PHP / Bitrix разработчик для сложных проектов',
  shortRole: 'PHP / Bitrix разработчик',
  experience: 'В разработке с 2016 года',
  tagline: 'Доработки, интеграции, оптимизация и безопасное развитие legacy.',
  summary:
    'Помогаю бизнесу, веб-студиям и продуктовым командам развивать проекты ' +
    'на PHP и 1С-Битрикс: разбираю старый код, стабилизирую интеграции, ' +
    'ускоряю узкие места и довожу задачи до результата.',
...
export const typicalTasks: readonly TaskItem[] = [
  ...
  {
    title: 'Студии нужен внешний senior-разработчик',
    description: 'Подключусь к команде на сложные задачи, аудит, архитектуру или интеграции.',
  },
  {
...
export const about = {
  summary:
    'В коммерческой PHP-разработке с 2016 года, с 2025 года работаю в роли ' +
    'архитектора на сложных Bitrix / PHP-проектах. Проектирую поддерживаемые ' +
    'решения, расцепляю legacy-код и помогаю командам безопасно развивать систему.',
  highlights: [
...
export const experience: readonly ExperienceItem[] = [
  {
    ...
    description:
      'Проектирую модульные решения на PHP и Bitrix D7, выделяю границы модулей, ' +
      'готовлю технические решения и помогаю командам безопасно развивать legacy.',
  },
  {
    period: '2019 — 2025',
